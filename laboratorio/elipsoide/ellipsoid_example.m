...
% Input: m-by-n matrix by Gr�tschel et al. 1981 p. 83 (failure in book in inequality (2): x2 -> x1 !)
C = [ 1 0 ; 2 3 ; -1 0 ; 0 -1];
d = [ 2   ; 5   ; 0 ; 0 ];
o = [ 1 1 ];

% Title
%title = 'Ellipsoid Method: Example by Gr�tschel et al. 1981 p. 83';

[a,iter] = ellipsoid_method(C,d,o,'central','optimize',1,'eps',0.001,'radius',5,'numiter',10,'plot_fig',1,'plot_iter',[0:10],'ignore_blowup',1);
